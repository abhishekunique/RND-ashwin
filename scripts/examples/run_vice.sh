softlearning run_example_local examples.classifier_rl \
        --exp-name=rerun_vice_embedding_fixed `# This is the name your experiment will be saved under ~/ray_results` \
        ...
        --trial-gpus=0.12  `# Number of GPUs that will be utilized PER seed` \
