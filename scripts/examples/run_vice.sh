softlearning run_example_local examples.classifier_rl \
        --exp-name=vice_gt_pairwise_embedding `# This is the name your experiment will be saved under ~/ray_results` \
        ...
        --trial-gpus=0.15  `# Number of GPUs that will be utilized PER seed` \
