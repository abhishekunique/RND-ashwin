softlearning run_example_local examples.classifier_rl \
        --exp-name=sac_test \               # This is the name your experiment will be saved under ~/ray_results
        --algorithm=SAC \                   # Algorithm of choice (ex: SAC, VICE, etc.) 
        --num-samples=2 \                   # Number of seeds PER choice of hyperparameters (will be multiplied by # of param combinations if you tune over a bunch)
